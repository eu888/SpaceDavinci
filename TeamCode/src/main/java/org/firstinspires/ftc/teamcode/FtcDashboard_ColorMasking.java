...
public class FtcDashboard_ColorMasking extends LinearOpMode {
    ...
    public static Scalar lowerYellow1 = new Scalar(20, 100, 100);
    public static Scalar upperYellow1 = new Scalar(30, 255, 255);
    public static Scalar lowerYellow2 = new Scalar(10, 100, 100);
    public static Scalar upperYellow2 = new Scalar(20, 255, 255);
    ...
    public static class CameraStreamProcessor implements VisionProcessor, CameraStreamSource{
        ...
        public Object processFrame(Mat frame, long captureTimeNanos) {
            ...
            Core.inRange(frame, lowerYellow1, upperYellow1, mask1);
            Core.inRange(frame, lowerYellow2, upperYellow2, mask2);
            Core.add(mask1, mask2, all);
            Bitmap b_peopleMask = Bitmap.createBitmap(frame.width(), frame.height(), Bitmap.Config.ARGB_8888);
            Utils.matToBitmap(all, b_peopleMask);
