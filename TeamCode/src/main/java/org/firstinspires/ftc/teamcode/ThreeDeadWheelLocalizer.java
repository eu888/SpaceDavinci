...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks =2087.7291585900007; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 4301.226705281309; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -4973.020978205977; // x position of the perpendicular encoder (in tick units)
    }
