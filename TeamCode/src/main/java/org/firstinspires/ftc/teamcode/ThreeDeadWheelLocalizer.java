...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks =-2218.7434208591108; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1834.9185554373605; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1649.3247278586252; // x position of the perpendicular encoder (in tick units)
    }
